...
namespace Utils.Encrypt
{
    public class RSA
    {
        public static string Encrypt(string sourceString, string publicKey, RSAEncryptionPadding encryptionPadding = null)
        {
        ...
        public static string Decrypt(string encryptString, string privateKey, RSAEncryptionPadding encryptionPadding = null)
        {
